class Stack:
    ''' class of stack, top of stack is on end of list
        Defined methods:
          ...
          pop - method which pull element from top of stack
    '''
    def __init__(self):
...
def move_tower(size, start, middle, final, poles):
    ''' recursive function which solve hanoi tower problem
        Arguments:
          size - size (height) of solved tower (non negative integer)
